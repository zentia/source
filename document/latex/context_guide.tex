...
\label{context_guide_md_runtime_2glfw_2docs_2context}%
\Hypertarget{context_guide_md_runtime_2glfw_2docs_2context}%
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__window_ga3c96d80d363e67d13a41b5d1821f3242}{GLFWwindow}}*\ second\_window\ =\ \mbox{\hyperlink{group__window_gaaccd00fafe81e2db94e8cdf55721e055}{glfwCreateWindow}}(640,\ 480,\ \textcolor{stringliteral}{"{}Second\ Window"{}},\ \mbox{\hyperlink{eabase_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}},\ first\_window);}

\end{DoxyCode}


\doxylink{class_object}{Object} sharing is implemented by the operating system and graphics driver. On platforms where it is possible to choose which types of objects are shared, GLFW requests that all types are shared.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__context_gafd76c93e15ec8b0b90506a9936a46185}{glfwMakeContextCurrent}}(\mbox{\hyperlink{joysticks_8c_a80de27bd7dc4e2b2ad3d5895b97a70f0}{window}});}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__window_ga3c96d80d363e67d13a41b5d1821f3242}{GLFWwindow}}*\ \mbox{\hyperlink{joysticks_8c_a80de27bd7dc4e2b2ad3d5895b97a70f0}{window}}\ =\ \mbox{\hyperlink{group__context_gab5fde1ef6238bfb82c7a2293f86172de}{glfwGetCurrentContext}}();}
...
See \doxysectlink{window_guide_buffer_swap}{Buffer swapping}{1} in the window guide.\hypertarget{context_guide_context_glext}{}\doxysection{\texorpdfstring{Open\+GL and Open\+GL ES extensions}{Open\+GL and Open\+GL ES extensions}}\label{context_guide_context_glext}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{joysticks_8c_a80de27bd7dc4e2b2ad3d5895b97a70f0}{window}}\ =\ \mbox{\hyperlink{group__window_gaaccd00fafe81e2db94e8cdf55721e055}{glfwCreateWindow}}(640,\ 480,\ \textcolor{stringliteral}{"{}My\ Window"{}},\ \mbox{\hyperlink{eabase_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}},\ \mbox{\hyperlink{eabase_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}});}
\DoxyCodeLine{\textcolor{keywordflow}{if}\ (!\mbox{\hyperlink{joysticks_8c_a80de27bd7dc4e2b2ad3d5895b97a70f0}{window}})}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ ...}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
