...
\label{intro_guide_md_runtime_2glfw_2docs_2intro}%
\Hypertarget{intro_guide_md_runtime_2glfw_2docs_2intro}%
...
\item \doxylink{glfw_2src_2init_8c_a1712210f34c339a05adda69e3587ec00}{glfw\+Init\+Vulkan\+Loader}
...
\DoxyCodeLine{allocator.\mbox{\hyperlink{struct_g_l_f_wallocator_a18a798136f17a9cb105be18312193bf7}{allocate}}\ =\ my\_malloc;}
\DoxyCodeLine{allocator.\mbox{\hyperlink{struct_g_l_f_wallocator_af5a674af9e170095b968f467233437be}{reallocate}}\ =\ my\_realloc;}
\DoxyCodeLine{allocator.\mbox{\hyperlink{struct_g_l_f_wallocator_ab74cf9a969e73e6eb65a6112a591a988}{deallocate}}\ =\ my\_free;}
\DoxyCodeLine{allocator.\mbox{\hyperlink{struct_g_l_f_wallocator_af6153be74dbaf7f0a7e8bd3bfc039910}{user}}\ =\ \mbox{\hyperlink{eabase_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}};}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}*\ my\_malloc(\textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a3d1e3edfcf61ca2d831883e1afbad89e}{size}},\ \textcolor{keywordtype}{void}*\ user)}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ ...}
\DoxyCodeLine{\}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}*\ my\_realloc(\textcolor{keywordtype}{void}*\ \mbox{\hyperlink{mimalloc_8h_a840cb394e7433c7fe0c4875a3030c955}{block}},\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{imgui__impl__opengl3__loader_8h_a3d1e3edfcf61ca2d831883e1afbad89e}{size}},\ \textcolor{keywordtype}{void}*\ user)}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ ...}
\DoxyCodeLine{\}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ my\_free(\textcolor{keywordtype}{void}*\ \mbox{\hyperlink{mimalloc_8h_a840cb394e7433c7fe0c4875a3030c955}{block}},\ \textcolor{keywordtype}{void}*\ user)}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ ...}
\DoxyCodeLine{\}}
...
The last \doxylink{namespacehalf__float_errors}{error code} for the calling thread can be queried at any time with \doxylink{group__init_gaee7bac4c7e1b2769207747c1b5ae2f9e}{glfw\+Get\+Error}.


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ code\ =\ \mbox{\hyperlink{group__init_gaee7bac4c7e1b2769207747c1b5ae2f9e}{glfwGetError}}(\mbox{\hyperlink{eabase_8h_a070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL}});}
\DoxyCodeLine{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{group__init_ga746e2757d069eaea423349aca6ae097a}{glfwSetErrorCallback}}(\mbox{\hyperlink{heightmap_8c_a6e6d1771a9242858811be0a3569838fa}{error\_callback}});}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{heightmap_8c_a6e6d1771a9242858811be0a3569838fa}{error\_callback}}(\textcolor{keywordtype}{int}\ code,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ description)}
\DoxyCodeLine{\{}
\DoxyCodeLine{\ \ \ \ display\_error\_message(code,\ description);}
\DoxyCodeLine{\}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{printf_8h_aee3ed3a831f25f07e7be3919fff2203a}{printf}}(\textcolor{stringliteral}{"{}Compiled\ against\ GLFW\ \%i.\%i.\%i\(\backslash\)n"{}},}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{printf_8h_aee3ed3a831f25f07e7be3919fff2203a}{printf}}(\textcolor{stringliteral}{"{}Running\ against\ GLFW\ \%i.\%i.\%i\(\backslash\)n"{}},\ major,\ minor,\ revision);}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{3.5.0\ Win32\ WGL\ Null\ EGL\ OSMesa\ MinGW\ DLL}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{3.5.0\ Wayland\ X11\ GLX\ Null\ EGL\ OSMesa\ monotonic}
