...
namespace source_module::rhi
{
	...
	{
	public:
		d3d12_viewport(d3d12_adapter* parent, HWND window_handle, uint32_t size_x, uint32_t size_y, bool is_fullscreen, source_runtime::core::pixel_format pixel_format);
		void initialize();
