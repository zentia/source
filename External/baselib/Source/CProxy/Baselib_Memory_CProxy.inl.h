...
BASELIB_INLINE_IMPL void Baselib_ErrorState_Validate_PageRange(uint64_t pageSize, uint64_t pageCount, uint64_t alignmentInMultipleOfPageSize, const Baselib_Memory_PageSizeInfo& pageSizeInfo, Baselib_ErrorState* errorState)
{
    if (pageCount == 0)
    {
...
BASELIB_INLINE_IMPL void Baselib_ErrorState_Validate_PageRange(uint64_t pageSize, uint64_t pageCount, const Baselib_Memory_PageSizeInfo& pageSizeInfo, Baselib_ErrorState* errorState)
{
    Baselib_ErrorState_Validate_PageRange(pageSize, pageCount, 1, pageSizeInfo, errorState);
}

BASELIB_INLINE_IMPL void Baselib_ErrorState_Validate_PageRange(uint64_t pageSize, uint64_t pageCount, Baselib_ErrorState* errorState)
{
...
BASELIB_INLINE_IMPL void Baselib_ErrorState_Validate_PageRange(const Baselib_Memory_PageAllocation& pageAllocation, Baselib_ErrorState* errorState)
{
...
BASELIB_C_INTERFACE
{
    ...
    Baselib_Memory_PageAllocation Baselib_Memory_AllocatePagesEx(uint64_t pageSize, uint64_t pageCount, uint64_t alignmentInMultipleOfPageSize, Baselib_Memory_PageState pageState, uint32_t extPageState, Baselib_ErrorState* errorState)
    {
        Baselib_Memory_PageSizeInfo sizeInfo;
        Baselib_Memory_GetPageSizeInfo(&sizeInfo);
        ...
        return platform::Baselib_Memory_AllocatePagesEx(pageSize, pageCount, alignmentInMultipleOfPageSize, pageState, extPageState, errorState);
    }
    ...
    {
        return Baselib_Memory_AllocatePagesEx(pageSize, pageCount, alignmentInMultipleOfPageSize, pageState, 0, errorState);
    }
    ...
    void Baselib_Memory_SetPageStateEx(void* addressOfFirstPage, uint64_t pageSize, uint64_t pageCount, Baselib_Memory_PageState pageState, uint32_t extPageState, Baselib_ErrorState* errorState)
    {
        ...
        return platform::Baselib_Memory_SetPageStateEx(addressOfFirstPage, pageSize, pageCount, pageState, extPageState, errorState);
    }
    ...
    {
        Baselib_Memory_SetPageStateEx(addressOfFirstPage, pageSize, pageCount, pageState, 0, errorState);
    }
}
