...
namespace Common
{
    ...
    )
    {
        ...
        void* memory = Baselib_Internal_Memory_AlignedAllocate(sizeof(Baselib_RegisteredNetwork_Socket_UDP_Impl), alignof(Baselib_RegisteredNetwork_Socket_UDP_Impl));
    ...
    )
    {
        ...
        Baselib_Internal_Memory_AlignedFree(socket);
    }
}
