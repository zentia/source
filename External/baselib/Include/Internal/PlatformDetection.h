...
// TODO: replace with actual define from TargetConditionals.h once it's there
// Also remove the defined(TARGET_OS_BRATWURST) check, it's there to silence warnings on undefined symbols used
